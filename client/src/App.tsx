    ...
    return (
      <div className="shell">
        <div className="state error">
          Server bilan bog'lanib bo'lmadi. Backend ishga tushganmi? (npm run dev)
          <br />
          <small>{error}</small>
        </div>
      </div>
  ...
  return (
    <div className="shell">
      <div className="topbar">
        <div className="brand">
          <h1>EduTizim</h1>
          <span className="sub">Moliya moduli — direktor paneli</span>
        </div>
      ...
      <footer className="pagefoot">
        Barcha summalar so'mda · {monthLabel(month)} · ikki tomonlama yozuv (double-entry)
        asosida
      </footer>
    </div>
  );
